...
def choose_file_and_delete_linex():
    ...
    check_path = None
    if account_choose == '1':
        path_file = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT.txt'
        check_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT-NAME-ID.txt'
    elif account_choose == '2':
        path_file = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT.txt'
        check_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT-NAME-ID.txt'
    elif account_choose == '3':
        path_file = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES.txt'
        check_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES-NAME-ID.txt'
    elif account_choose == '4':
        path_file = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES.txt'
        check_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES-NAME-ID.txt'
...
def display_file_info():
    ...
    while True:
        ...
        if file_choose == '1' or file_choose == '01':
            file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT-NAME-ID.txt'
            display_file_content(file_path)
            break
        elif file_choose == '2' or file_choose == '02':
            file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT-NAME-ID.txt'
            display_file_content(file_path)
            break
        elif file_choose == '3' or file_choose == '03':
            file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES-NAME-ID.txt'
            display_file_content(file_path)
            break
        elif file_choose == '4' or file_choose == '04':
            file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES-NAME-ID.txt'
            display_file_content(file_path)
            break
...
def delete_files():
    ...
    while True:
        ...
        if account_choose == '1' or account_choose == '01':
            file_paths = [
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT.txt',
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT-NAME-ID.txt']
            all_deleted = True
            ...
            file_paths = [
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT.txt',
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT-NAME-ID.txt']
            all_deleted = True
            for file_path in file_paths:
                if os.path.exists(file_path):
                    os.remove(file_path)
            ...
            file_paths = [
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES.txt',
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES-NAME-ID.txt']
            all_deleted = True
            for file_path in file_paths:
                if os.path.exists(file_path):
                    os.remove(file_path)
            ...
            file_paths = [
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES.txt',
                'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES-NAME-ID.txt']
            all_deleted = True
            for file_path in file_paths:
                if os.path.exists(file_path):
                    os.remove(file_path)
...
def extract_and_save_facebook_pages():
    ...
    linex()
    paths = {
        '1': ['C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT.txt', 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT-NAME-ID.txt'],
        '2': ['C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT.txt', 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT-NAME-ID.txt'],
        '3': ['C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES.txt', 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES-NAME-ID.txt'],
        '4': ['C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES.txt', 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES-NAME-ID.txt']
    }
...
def get_facebook_account():
    ...
    try:
        ...
        if 'session_key' in po:
            ...
            token = po.get('access_token', '')
            open('C:\\Users\\Admin\\Documents\\.EXTRACT-COOKIE-ACCOUNT-NAME-ID.txt','a').write(f'{cookie}\n')
...
def _Cookies(id):
    ...
    if 'c_user' in _cookies:
        print(f'''  {white}ID : {yellow}{uid} {white}---> {green}Successfully Extract!''')
        linex()
        with open('C:\\Users\\Admin\\Documents\\.EXTRACT-COOKIE-ACCOUNT.txt', 'a') as f:
            f.write(_cookies + '\n')
...
def react():
    ...
    file_path = None
    if account_choose == '1' or account_choose == '01':
        file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT.txt'
    elif account_choose == '2' or account_choose == '02':
        file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT.txt'
    elif account_choose == '3' or account_choose == '03':
        file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES.txt'
    elif account_choose == '4' or account_choose == '04':
        file_path = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES.txt'
    elif account_choose == '0' or account_choose == '00':
        main()
        return
...
def react_with_care():
    clear()
    logo()
    coki_file_name = 'C:\\Users\\Admin\\Documents\\.EXTRACT-COOKIE-ACCOUNT.txt'
    try:
...
def auto_comment():
    ...
    linex()
    file_paths = {
        '1': 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT.txt',
        '2': 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT.txt',
        '3': 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES.txt',
        '4': 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES.txt'
    }
...
path_file1 = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT.txt'
path_file2 = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT.txt'
path_file3 = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES.txt'
path_file4 = 'C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES.txt'

def main():
    clear()
    logo()
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT.txt', 'a').write('')
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-ACCOUNT-NAME-ID.txt', 'a').write('')
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT.txt', 'a').write('')
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-ACCOUNT-NAME-ID.txt', 'a').write('')
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES.txt', 'a').write('')
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-FRA-PAGES-NAME-ID.txt', 'a').write('')
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES.txt', 'a').write('')
    open('C:\\Users\\Admin\\Documents\\.EXTRACT-TOKEN-RP-PAGES-NAME-ID.txt', 'a').write('')
